...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center w-full">
      <div className="mx-auto w-full max-w-lg bg-secondary rounded-xl p-10 border border-primary">
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  id="email"
                  {...register("email")}
                  className="flex h-10 w-full rounded-md border bg-transparent px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                  placeholder="Email"
                />
